...
@onready var yellow_button: AnimatedSprite2D = $"yellow button"
...
func _on_body_entered(body: Node2D) -> void:
	print(body.name)
	yellow_button.play("yellowBlink")
	GameManager.planet_2_door_open = true
